...
/// <summary>
/// Ray budget for <see cref="CaelixBudgetGBufferPass"/>. Built from the budget feature's
...
/// </remarks>
[Serializable]
public struct CaelixBudgetTraceSettings
{
    ...
    public static CaelixBudgetTraceSettings Default => new CaelixBudgetTraceSettings
    {
    ...
    public CaelixBudgetTraceSettings Validated()
    {
        CaelixBudgetTraceSettings v = this;
...
/// </summary>
[Serializable]
public struct CaelixBudgetShadingSettings
{
    ...
    public static CaelixBudgetShadingSettings Default => new CaelixBudgetShadingSettings
    {
        skyIntensity = 2.0f,
        skyDiffuseMip = 6.0f,
    ...
    /// <summary>Clamps user-authored values into ranges the shaders can handle.</summary>
    public CaelixBudgetShadingSettings Validated()
    {
        CaelixBudgetShadingSettings v = this;
