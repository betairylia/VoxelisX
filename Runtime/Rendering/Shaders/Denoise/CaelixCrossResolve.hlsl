#ifndef CAELIX_CROSS_RESOLVE_INCLUDED
#define CAELIX_CROSS_RESOLVE_INCLUDED
...
float4 CaelixCrossResolve(uint2 centerCoord)
{
    ...
    {
        uint2 tapCoord = CaelixClampCoord(int2(centerCoord) + tapOffsets[tap]);
