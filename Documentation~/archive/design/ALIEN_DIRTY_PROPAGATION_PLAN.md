...
The physics voxel collision path is useful as a reference for source-to-target coordinate transforms, but this system should live in Caelix core/simulation. Dirty propagation must not depend on physics bodies, contact generation, or physics scheduling.
