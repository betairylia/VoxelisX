...
namespace VoxelisX.Tests
{
    public class AlienDirtyPropagationScenarioTests
    {
        ...
        public void DirtyBrickInEntityMarksOverlappingTargetBrick()
        {
            ...
            Assert.That(RequireFlags(target, int3.zero, int3.zero) & (ushort)DirtyFlags.Reserved0, Is.Not.EqualTo(0));
        ...
        public void AlienPropagationSkipsSelf()
        {
            ...
            Assert.That(RequireFlags(source, int3.zero, int3.zero) & (ushort)DirtyFlags.Reserved0, Is.EqualTo(0));
        }
        ...
        private static AlienDirtyPropagationSettings BlockEditSettings()
        {
            ...
            settings.FlagsToPropagate = DirtyFlags.Reserved0;
